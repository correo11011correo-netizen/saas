...
class CRMService:
    ...
    def create_or_update_customer(self, tenant_id: UUID, phone: str, name: Optional[str] = None, email: Optional[str] = None, metadata: Optional[Dict] = None) -> Customer:
        ...
        if customer:
            ...
            if metadata: customer.metadata.update(metadata)
